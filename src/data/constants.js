  ...
  export const skills = [
    {
      ...
      skills: [
        ...
        },
        {
          name: "Bulma",
          image:
            "https://image.pngaaa.com/787/6130787-middle.png",
        },
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          name: "DBeaver",
          image:
            "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/DBeaver_logo.svg/1200px-DBeaver_logo.svg.png",
        },
        {
          name: "Insomnia",
          image:
            "https://image.pngaaa.com/268/4842268-middle.png",
        },
      ],
    },
  ];
  ...
  export const projects = [
    {
      ...
      image:
        "https://private-user-images.githubusercontent.com/144052327/274640610-ea116b73-7a87-42c4-9659-f6dbd71111e4.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTEiLCJleHAiOjE3MDE2MjUxNzksIm5iZiI6MTcwMTYyNDg3OSwicGF0aCI6Ii8xNDQwNTIzMjcvMjc0NjQwNjEwLWVhMTE2YjczLTdhODctNDJjNC05NjU5LWY2ZGJkNzExMTFlNC5wbmc_.9IkFiwEGRA7hcK8VxG1xFxErMX4h4sD9vrgy6zDnrm4",
      tags: [
        "HTML",
        "CSS",
        "JavaScript",
      ...
      member: [
        {
          name: "Trae Roy",
          img: "https://avatars.githubusercontent.com/u/89883055?v=4",
          github: "https://github.com/Roesnware",
        },
        {
          name: "Narvin Blas",
    ...
    },
    {
      ...
      date: "November 2023",
      description:
        "Social Network API, a robust solution for handling large amounts of unstructured data in a social media web application. This API is built using Express.js for routing, MongoDB as the NoSQL database, and Mongoose ODM for seamless interaction with the database.",
      image:
        "https://github.com/Quebvihn/Social-Network-Api/raw/main/images/Screenshot%202023-11-22%20182203.png",
      tags: [
        "JavaScript",
        "MongoDB",
        "Node Js",
